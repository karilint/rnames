...
def bin_fun_macrostrat (c_rels, binning_scheme, ts_names, t_scales):
    ...
    #c_rels_abs = c_rels_abs[(c_rels_abs['name_two_remarks']=='Autogenerated by Macrostrat importer.')] # all absolute ages of ts
    #print(c_rels_abs)
    ...
    if abs_ts.shape[0]>0:
        ...
        #Macrostrat_names_binned = PBDB_names_binned
