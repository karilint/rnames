...
def pbdb_import(cc2):
    ...
    relations_PBDB_final = relations_PBDB[['Name_one', 'Qualifier_one', 'Location_one', 'Name_two', 'Qualifier_two',
                                'Location_two', 'Reference', 'Belongs_to']]
    relations_PBDB_final['Name_one_remarks'] = 'Autogenerated by PBDB importer.'
    relations_PBDB_final['Name_two_remarks'] = 'Autogenerated by PBDB importer.'
