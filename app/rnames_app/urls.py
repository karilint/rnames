...
urlpatterns = [
    ...
    path('rnames/admin/binning/<int:scheme_id>', views.run_binning, name='run-binning'),
    path('rnames/admin/binning_done/<int:scheme_id>', views.external, name='done-binning'),
    path('rnames/admin/binning_status/<str:task_id>/', views.binning_status, name='binning-status'),
    path('rnames/admin/binning_progress/<str:task_id>/<int:pk>', views.binning_progress, name='binning-progress'),
    path('rnames/admin/import/pbdb', views.pbdb_import),
    path('rnames/admin/import/macrostrat', views.macrostrat_import),
    ...
    path('rnames/time-scale/<int:pk>/result/binning', views.time_scale_result_binning, name='time-scale-result-binning'),
    path('rnames/time-scale/<int:pk>/result/absolute-age', views.time_scale_result_absolute_age, name='time-scale-result-absolute-age'),
    path('rnames/time-scale/<int:pk>/result/generalised', views.time_scale_result_generalised, name='time-scale-result-generalised'),
